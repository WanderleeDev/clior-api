import { Product } from 'src/modules/product/domain/model/product';
import { ProductResponseDto } from 'src/modules/product/application/dto';
import { ProductBuilder } from 'src/modules/product/domain/product.builder';
import { ProductEntity } from 'src/modules/product/infrastructure/adapters/out/product.entity';
import { NULL_PRODUCT } from 'src/modules/product/const';
